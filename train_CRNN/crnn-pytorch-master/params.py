...
imgW = 400 # the width of the input image to network
nh = 360 # size of the lstm hidden state
nc = 1
...
valInterval = 2700 # interval to val the model loss and accuray
saveInterval = 2700 # interval to save model
n_val_disp = 20 # number of samples to display when val the model

# finetune
nepoch = 50 # number of epochs to train for
batchSize = 192 # input batch size
