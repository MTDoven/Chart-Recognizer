    ...
    for epoch in range(params.nepoch):
        ...
        while i < len(train_loader):
            ...
            if i % params.saveInterval == 0:
                # torch.save(crnn.state_dict(), '{0}/netCRNN_{1}_{2}.param'.format(params.expr_dir, epoch, i))
                torch.save(crnn, '{0}/netCRNN_{1}_{2}_accuracy{3}.model'.format(params.expr_dir, epoch, i, accuracy))
                torch.save(optimizer, '{0}/netCRNN_{1}_{2}.optimizer'.format(params.expr_dir, epoch, i))
